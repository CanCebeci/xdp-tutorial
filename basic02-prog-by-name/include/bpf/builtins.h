...
__bpf_memcmp_builtin(void *x, void *y, __u64 len)
{
...
static __always_inline __u64 __bpf_memcmp(void *x, void *y,
					  __u64 len)
{
#if __clang_major__ >= 10
	__u64 r = 0;
 ...
 */
static __always_inline __nobuiltin("memcmp") __u64 memcmp(void *x,
							  void *y,
							  __u64 len)
{
