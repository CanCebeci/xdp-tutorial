...
static int redirect_peer(int ifindex, __u32 flags) {return 0;}
...
static int skb_event_output(struct __sk_buff *skb, void *map,
			  __u64 index, const void *data, __u32 size) {return 0;}
