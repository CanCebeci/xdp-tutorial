...
BPF_CFLAGS += -D__NR_CPUS__=96 -O2 -g -target bpf -std=gnu89 -emit-llvm -Wall -Werror -Wshadow -Wno-address-of-packed-member -Wno-unknown-warning-option -Wno-gnu-variable-sized-type-not-at-end -Wdeclaration-after-statement # -nostdinc -Wextra (complains about unused params)
